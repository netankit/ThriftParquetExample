...
public class EmployeeId implements
		...
		java.io.Serializable, Cloneable, Comparable<EmployeeId> {
	...
	static {
		schemes.put(StandardScheme.class, new EmployeeIdStandardSchemeFactory());
		schemes.put(TupleScheme.class, new EmployeeIdTupleSchemeFactory());
	}
	...
	private static class EmployeeIdStandardSchemeFactory implements
			SchemeFactory {
		public EmployeeIdStandardScheme getScheme() {
			return new EmployeeIdStandardScheme();
		}
	}

	private static class EmployeeIdStandardScheme extends
			StandardScheme<EmployeeId> {

		public void read(org.apache.thrift.protocol.TProtocol iprot,
				EmployeeId struct) throws org.apache.thrift.TException {
	...
	private static class EmployeeIdTupleSchemeFactory implements SchemeFactory {
		public EmployeeIdTupleScheme getScheme() {
			return new EmployeeIdTupleScheme();
		}
	}

	private static class EmployeeIdTupleScheme extends TupleScheme<EmployeeId> {
